    ...
    $(document).ready(function() {
        ...
        function checkForm() {
            ...
            function checkfields() {
                ...
                if (noSubmit) {
                    $('#result').delay(1500).show(0, function() {
                        $('#processingHolder').slideUp(250);
                        $('#processResponse').html("<p class=\"errorfield\">Your result cannot be submitted as we are missing some of the required fields. Missing fields have been highlighted.</p>").delay(250).slideDown(250);
                        $('#result').delay(250).slideDown(500);
                        $('.errorfield').show();
                    });
                } else {
                    $('#drawtype').val($(this).attr('id'));
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.error) {
                                ...
                                $('#processingHolder').slideUp(500);
                                $('#processResponse').append("<p>" + data.msg + "</p>").slideDown(250);
