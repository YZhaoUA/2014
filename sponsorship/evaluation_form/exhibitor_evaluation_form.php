                ...
                <form name="registration" id="registration" method="post" action="">
                    ...
                    <div id="registerInfo"> 
                        ...
                        <div id="registrantInfo" class="formBlock" style="clear:left; width:100%;">
                            <h2>Exhibitor Evaluation Form</h2>
                            <h1 class="red"><em>If you were an exibitor at the Banff/2015 Pipeline Workshop <br>
                                    please complete this survey.</em></h1>
                            <p><strong>Complete the evaluation form before April 18 to be entered into a draw for 1 of 4 <br>
                                    $50 American Express Prepaid Gift Cards!</strong></p>
                            ...
                            <div class="leftCol required" style="width:90%;">
                                ...
                                <div class="leftCol notRequired" style="width:97%;">
                                    <p>
                                        <textarea name="question<?php echo $i; ?>objectives" cols="60" rows="6" id="question<?php echo $i; ?>objectives" class="reqfield comment" style="width:97%;"></textarea>
                                        <br>
                                        250 characters maximum. You have <span id="question<?php echo $i; ?>objectiveschar"></span> charcters left. </p>
                                </div>
                                <script>
                                    $(document).ready(function() {
                                ...
                                <div class="leftCol notRequired" style="width:97%;">
                                    <p>
                                        <textarea name="question<?php echo $i; ?>achieved" cols="60" rows="6" id="question<?php echo $i; ?>achieved" class="reqfield comment" style="width:97%;"></textarea>
                                        <br>
                                        250 characters maximum. You have <span id="question<?php echo $i; ?>achievedchar"></span> charcters left. </p>
                                </div>
                                <script>
                                    $(document).ready(function() {
                                ...
                                <div class="leftCol notRequired" style="width:97%;">
                                    <p>
                                        <textarea name="question<?php echo $i; ?>comments" cols="60" rows="6" id="question<?php echo $i; ?>comments" class="reqfield comment" style="width:97%;"></textarea>
                                        <br>
                            ...
                            <div class="leftCol required" style="width:90%;">
                                ...
                                <div class="leftCol notRequired" style="width:97%;">
                                    ...
                                    <div class="leftCol" style="width:97%;">
                                        ...
                                        <p>
                                            <input name="company" type="text" id="company" value="" maxlength="50"  class="reqfield"/>
                                        </p>
                                    </div>
                                </div>
                            </div>
