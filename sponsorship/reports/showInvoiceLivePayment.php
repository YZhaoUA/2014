...
<html>
    <head>
        ...
        <script type="text/javascript" src="../onsite/js/regForm.php"></script>
...
// }
                    ...
                    if (isset($_POST['print'])) {
                        ...
                        if ($_GET['vid']) {
                            if (substr($_GET['vid'], 0, 4) == "BPW-") {
                                $vid = substr($_GET['vid'], 4);
                            } else {
                                $vid = $_GET['vid'];
                            }
                        }
                        ...
                        //////////////////////////////////////////////////////////////////////////////////
                        // promo code
                        //echo "<p>1 charged: $totalcharged / due: $totaldue</p>";
                        if (!isset($promoCode)) {
                        ...
                        if (isset($promoCode) && $promoCode != "") {
                            ...
                            //echo "<p>3 charged: $totalcharged / due: $totaldue</p>";
...
//echo "<p>test values (update not actually happening):</p><p>update $tablesponsor set totalcharged='$totalcharged', totaldue='$totaldue', datepaid='$today', paytype='PROMO' where vid='$vid'</p>";
                            $today = date('Y-m-d');
                            ...
                            } else if (isset($_POST['promoCode']) && !isset($_POST['payOpt'])) {
                            ...
                            // clear out any promo codes using current vid
                            $promo = "update $tablepromo set invoiceSponsor='' where invoiceSponsor='$vid'";
                            $promores = mysql_query($promo);
                            ...
                            // update lan system
                            $onsitepath = '../';
                            //include('../includes/clearPromoInvoice.php');
                        }
                        //////////////////////////////////////////////////////////////////////////////////
                        //////////////////////////////////////////////////////////////////////////////////
                        ?>
                        <form method='post' action='' name='invoice' ENCTYPE='multipart/form-data' >
                            ...
                            <p><a href="reg_history.php?vid=<?php echo $vid; ?>" onClick="CentreWindow(this.href, 'RegHist', 950, 600);
                                        return false;">View Registration History </a> </p>
                                <?php
...
///////////////////////end of payment history //////////////////////////////////////	
                                ...
                                echo $invoice_info;
                                ?>
                            <h1>Process Credit Card - Live Transaction against card</h1>
                            <p>
                                ...
                                ?>">
                                       <?php
                                       $returnAddress = str_replace("paymentResponse.php", "reports/paymentResponse.php", $beanstreamReturnAddress);
                                       ?>
                                <input type="hidden" name="errorPage" value="<?php echo $returnAddress; ?>">
                                <input type="hidden" name="approvedPage" value="<?php echo $returnAddress; ?>">
                                <input type="hidden" name="declinedPage" value="<?php echo $returnAddress; ?>">
                                <input name="livePayment" type="submit" class="transformButtonStyle" id="livePayment" onClick="document.invoice.enctype = '';
                                            document.invoice.encoding = '';
                                            document.invoice.action = '<?php echo $beanstreamTransactionAddressOnsite; ?>';
                                            document.invoice.processing.value = 'YES';" value="Proceed to Payment Gateway">
                            </p>
                            <p>&nbsp;</p>
                            <h2>DO NOT REFRESH THIS PAGE!! Refreshing may cause a processed payment to be duplicated. </h2>
                            <p>&nbsp;</p>
                            ...
                            <table width="100%" border="0" cellpadding="5" cellspacing="0" class="tableOutline">
                                ...
                                <tr>
                                    <td colspan="2" align="left" valign="top"><table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" >
                                            <tr>
                                                <td colspan="4"><h1>Payment Options</h1></td>
                                            </tr>
                                            <tr>
                                                <td width="5"><p>
                                                        <input name="payment_type" type="radio" value="CC">
                                                    </p></td>
                                                <td width="102"><p>Credit Card</p></td>
                                                <td width="5"><p>
                                                        <input name="payment_type" type="radio" value="CHEQUE">
                                                    </p></td>
                                                <td width="133"><p>Company Cheque</p></td>
                                            </tr>
                                            <tr>
                                                <td width="5"><p>
                                                        <input name="payment_type" type="radio" value="BANK">
                                                    </p></td>
                                                <td><p>Bank Transfer</p></td>
                                                <td width="5"><p>
                                                        <input name="payment_type" type="radio" value="MONEYORDER">
                                                    </p></td>
                                                <td><p>Money Order</p></td>
                                            </tr>
                                            <tr>
                                                <td><p>
                            ...
                            <p>
                                ...
                                <input name="printType" type="hidden" value="">
                            ...
                            <p>
                                <input name="invoice2" type="submit" class="transformButtonStyle" onclick="document.invoice.printType.value = 'invoice';
                                            this.form.action = 'printmessage.php';" value="Print Invoice">
                                <input name="card" type="submit" class="transformButtonStyle" onclick="document.invoice.printType.value = 'badge';
                                            this.form.action = 'printmessage.php';" value="Print Badge">
                                <input name="both" type="submit" class="transformButtonStyle" id="both" onClick="document.invoice.printType.value = 'both';
                                            this.form.action = 'printmessage.php';" value="Print Both">
                            </p>
                            <?php /* $onsitepath = "../"; include('../includes/duplicateRecords.php'); */ ?>
                        </form>
                        <?php
                        mysql_close($link);
                    }
